...
1. 打开仓库文件 `gemini-chat-copier.user.js`
2. 全选复制内容
3. 在脚本管理器中新建脚本并粘贴保存
...
2. 页面顶部中央会出现按钮栏：`[Markdown ▼] [📋 Copy] [💾 Save] [📷] [👁] [⚙️]`
...
| 库 | 用途 | 加载方式 |
|----|------|----------|
| Turndown 7.2.0 | HTML → Markdown 转换 | `@require` CDN |
| turndown-plugin-gfm 1.0.2 | GFM 表格/删除线/任务列表 | `@require` CDN |
| html2canvas 1.4.1 | PNG 截图 | `@require` CDN |
